...
{$lang['details_enter_id']}<br /></form>" : "{$lang['details_yours']}")."</td>
    ...
    $HTMLOUT .= "<tr><td align='right' valign='top'><b>{$lang['details_filled']}</b></td><td><a class='altlink' href='details.php?id=".intval($num['torrentid'])."'><b>".$INSTALLER09['baseurl']."/details.php?id=".intval($num['torrentid'])."</b></a></td></tr>";	
