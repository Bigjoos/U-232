...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //== Preview POST data ...
    $body    = trim((isset($_POST['msg']) ? htmlspecialchars($_POST['msg']) : ''));
    $subject = trim((isset($_POST['subject']) ? htmlspecialchars($_POST['subject']) : ''));
    $expiry  = 0 + (isset($_POST['expiry']) ? intval($_POST['expiry']) : 0);
