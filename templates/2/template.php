...
function stdhead($title = "", $msgalert = true, $stdhead = false) {
    global $CURUSER, $INSTALLER09, $lang, $free, $_NO_COMPRESS, $mc;
    ...
    <body>
      ...
      <td class='clear'>
      <div id='logostrip'>
      <img src='{$INSTALLER09['pic_base_url']}logo.jpg' alt='' />
      <a href='donate.php'><img src='{$INSTALLER09['pic_base_url']}x-click-but04.gif' border='0' alt='{$lang['gl_donate']}' title='{$lang['gl_donate']}' style='margin-top: 5px' /></a>
      </div>
      </td>
      </tr></table>
...
global $querytime, $CURUSER, $INSTALLER09, $q, $queries, $query_stat;
    ...
    <span class='server'>The {$INSTALLER09['site_name']}
    ...
    <a href='http://www.tbdev.net'><img src='{$INSTALLER09['pic_base_url']}tbdev_btn_red.png' border='0' alt='Powered By TBDev &copy;2009' title='Powered By TBDev &copy;2009' /></a><br /><br /></p></td></tr></table>";
    /** query stats **/
    /** include js files needed only for the page being used by pdq **/
...
////////////// REP SYSTEM END //////////
    ...
    $usrclass = "&nbsp;<a href='{$INSTALLER09['baseurl']}/setclass.php'><b>(".get_user_class_name($CURUSER['class']).")</b></a>&nbsp;";
	  $StatusBar = '';
		...
		"."&nbsp;$member_reputation".
		"&nbsp;&nbsp;Invites:&nbsp;<a href='{$INSTALLER09['baseurl']}/invite.php'>{$CURUSER['invites']}</a>"."
		&nbsp;&nbsp;Bonus:&nbsp;<a href='{$INSTALLER09['baseurl']}/mybonus.php'>{$CURUSER['seedbonus']}</a>";
		if(!$INSTALLER09['coins'])
		$StatusBar .= "
		...
		"&nbsp;&nbsp;<img alt='{$lang['gl_leech_torrents']}' title='{$lang['gl_leech_torrents']}' src='{$INSTALLER09['pic_base_url']}dl.png' />&nbsp;".($INSTALLER09['max_slots'] ? "<a title='I have ".$max." Download Slots'>{$seedleech['no']}/".$max."</a>" : $seedleech['no'])."</div>".
