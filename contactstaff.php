...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (sql_query('INSERT INTO staffmessages (sender, added, msg, subject) VALUES(' . sqlesc($CURUSER['id']) . ', ' . sqlesc(time()) . ', ' . sqlesc($msg) . ', ' . sqlesc($subject) . ')') or sqlerr(__FILE__, __LINE__)) {
        ...
        stderr($lang['contactstaff_error'], $lang['contactstaff_mysql_err']);
} else {
    ...
    echo stdhead($lang['contactstaff_header']) . $HTMLOUT . stdfoot();
}
?>
