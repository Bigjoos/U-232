...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $res1 = sql_query("INSERT INTO messages (sender, poster, receiver, subject, msg, added) VALUES (0, 0, " . sqlesc($CURUSER['id']) . ", " . sqlesc($subject) . ", " . sqlesc($msg) . ", '" . time() . "')") or sqlerr(__FILE__, __LINE__);
